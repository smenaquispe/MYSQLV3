#ifndef FIND_AND_REPLACE_REGISTRO
#define FIND_AND_REPLACE_REGISTRO

#include"Disco.h"

void Disco::findAndReplaceRegistro(const char * idRegistro, char * auxBuffer) {
    ...
    sectorFile.write(auxBuffer, file->totalRegisterBytes);
